    ...
    pub fn rotate(&mut self, rotation: Rotation) -> usize {
        ...
        match rotation {
            Rotation::Left(val) => {
                ...
                for _ in 0..val {
                    self.ptr = (self.ptr - 1).rem_euclid(self.len as isize);
...
mod tests {
    use std::str::FromStr;
    use crate::part_2::{process, Dial, Rotation};
    use crate::part_2::Rotation::{Left, Right};
